...
abstract class AppBinderModule {
    ...
    @Binds
    @IntoMap
    @WorkerKey(UploadTravelWorker::class)
    abstract fun bindUploadTravelWorkerFactory(builder: DataFetchWorkerSubComponent.Builder): AndroidInjector.Factory<out Worker>
